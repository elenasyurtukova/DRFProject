...
class LessonTestCase(APITestCase):
    def setUp(self):
        ...
        self.course = Course.objects.create(title_course="test_course_1", owner=self.user)
        self.lesson = Lesson.objects.create(title_lesson="test_lesson_1", course=self.course, owner=self.user,
